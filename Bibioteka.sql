...
INSERT INTO PASNIEDZEJI (PASN_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE) --parole(Parole123)
VALUES (1, 'Jānis', 'Kalniņš', 'JanKal', 'janis.kalnins@example.com', '20479b35a5e168bbbb446a59f3a7dc324293ef41a38096431310a316b19d99f2');

INSERT INTO PASNIEDZEJI (PASN_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE) --parole(AnnaParole)
VALUES (2, 'Anna', 'Bērziņa', 'PasniedzAnna', 'anna.berzina@example.com', '9444708f96fa644af43137c8e608916cb0cb3a629726c1954137449730c56480');
...
INSERT INTO STUDENTI (STUD_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE, GRUPA_ID) --parole(Stud123)
VALUES (1, 'Marta', 'Ozoliņa', 'MG1234', 'marta.ozolina@example.com', '6e81b51ae06e9803d46257a3246b0e262331f06d30a30980b4e1d7ea176205cb', 1);

INSERT INTO STUDENTI (STUD_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE, GRUPA_ID) --parole(Stud456)
VALUES (2, 'Andris', 'Eglītis', 'MG2435' 'andris.eglitiss@example.com', 'aa4dd218269b2a0a1718a2b507458fd0c3366fda82870f32485fcbd9dde9f1dd', 1);

INSERT INTO STUDENTI (STUD_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE, GRUPA_ID) --parole(Stud789)
VALUES (3, 'Laura', 'Kļaviņa', 'MG782', 'laura.klavina@example.com', '39a76bc42d4a89ee70743c6d5f7718e384acae0a0a765da7301013656be15ab2', 1);

INSERT INTO STUDENTI (STUD_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE, GRUPA_ID) --parole(StudABC)
VALUES (4, 'Edgars', 'Zālītis', 'BH2765', 'edgars.zalitis@example.com', 'cda221a33616982c25e5ae3af854db3d269613df325a0e90c70a79534a92f073', 2);

INSERT INTO STUDENTI (STUD_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE, GRUPA_ID) --parole(StudDEF)
VALUES (5, 'Ilze', 'Krūmiņa', 'BH9087', 'ilze.krumina@example.com', '6b7360b2ffe6b151d19ed1676b6832f99969199c6d77b86c77190c415b86ab2f', 2);

INSERT INTO STUDENTI (STUD_ID, VARDS, UZVARDS, LIETOTAJVARDS, EPASTS, PAROLE, GRUPA_ID) --parole(StudGHI)
VALUES (6, 'Juris', 'Lūsis', 'BH9992', 'juris.lusis@example.com', 'c1c5fbfabca6c6b3157b99c2fb762a98b2919ff4a9a7158ada6a572e3fec1e17', 2);
